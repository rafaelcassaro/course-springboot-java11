package com.unitycourse.course.entities;
...
public class Order implements Serializable{
	...
	//ligar os mtos orderitem com o unico order
	@OneToMany(mappedBy = "id.order")  //o id do orderItem q tem o pedido
	private Set<OrderItem> items = new HashSet<>();
	
	@OneToOne(mappedBy = "order", cascade = CascadeType.ALL) //mappedBy é o nome do atributo Order na classe payment
	private Payment payment;								 //cascade é para o id do payment e pedido ser o msm
